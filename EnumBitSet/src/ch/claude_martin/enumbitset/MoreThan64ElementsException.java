...
/** Unchecked exception for any method that uses a bit set of type long (64 bits) even though the
 * type contains more than 64 elements.
 * 
 * <p>
...
public class MoreThan64ElementsException extends RuntimeException {
  ...
  /** Used for a Set with a general domain. */
